...
export default function Home() {
  return <main>
    ...
    <div className="card"><h2>M1 — Training Loop Alpha</h2><p>Operational dogfood workflow with immutable execution snapshots under the canonical program.</p></div>
    ...
    <div className="card"><h2>B12 — Hardening & Cutover Readiness</h2><p>Security, reconciliation, export, and retained-history gates are verified.</p></div>
    <div className="card"><h2>B13 — Health Canonical Reconciliation</h2><p>Canonical cutover is complete. Superabang is authoritative, with source provenance, prior dogfood versions, uncertainty, and the active safety block preserved.</p></div>
    <div className="row">
      ...
      <Link href="/program-change"><button>Program change</button></Link>
      ...
      <Link href="/canonical-reconciliation"><button>B13 reconciliation</button></Link>
